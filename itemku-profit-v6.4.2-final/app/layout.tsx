...
export const metadata: Metadata = {
  title: 'Itemku Profit Management V6.4.2',
  description: 'Itemku Profit Management V6.4.2 untuk order, stok, profit, recovery, observability, worker, supplier, dan kontrol operasional.',
