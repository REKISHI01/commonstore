-- Itemku Profit V5.2 reference schema. No new business tables are required from V5.1.
...
-- V4.4 Decision Intelligence update
-- Tidak ada tabel/RPC baru yang wajib. Modul V4.4 bersifat derived analytics dan memakai struktur data V4.3/V4.1 yang sudah ada:
-- products, orders, restocks, suppliers, settlements, disputes, expenses, channel_rules.
-- Upgrade V4.3 -> V4.4 cukup deploy source V4.4. Menjalankan schema ini aman sebagai schema referensi instalasi baru.
